...
**Note:** agent uses csv file rather than one api
...
**Note:** agent also checks feedback_times-goCue_times < MAX_TRIAL_LEN, feedback_times non-nan
...
**Note:** crops timestamps from the end rather than the start
