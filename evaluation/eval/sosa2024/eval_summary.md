...
| Agent / trial | LZ | KB | Claude judge | Codex judge | Best | Why |
|---|---|---|---|---|---|---|
| claude-code / trial1 | match | match | concerning | concerning | Claude judge | AI Correctly identified that the agent code is less robust |
| claude-code / trial2 | match | match | match | concerning | — |  |
| claude-code / trial3 | match | match | concerning | incorrect | Claude judge |  |
| codex / trial1 | match | match | match | match | — |  |
...
| claude-code / trial2 | ok | ok | incorrect | incorrect | LZ |  |
| claude-code / trial3 | better | better | concerning | incorrect | LZ |  |
| codex / trial1 | ok | better | concerning | incorrect | LZ |  |
| codex / trial2 | ok | better | incorrect | incorrect | LZ |  |
| codex / trial3 | better | better | incorrect | incorrect | LZ |  |
...
| claude-code / trial3 | match | ok | better | incorrect | LZ |  |
...
| claude-code / trial2 | match | concerning | concerning | incorrect | LZ |  |
...
| codex / trial2 | match | match | match | ok | — |  |
| codex / trial3 | match | match | concerning | ok | LZ |  |
...
| Agent / trial | LZ | KB | Claude judge | Codex judge | Best | Why |
|---|---|---|---|---|---|---|
| claude-code / trial1 | concerning | ok | ok | incorrect | LZ |  |
...
| claude-code / trial3 | match | match | match | match | — |  |
| codex / trial1 | match | match | match | match | — |  |
| codex / trial2 | incorrect | incorrect | match | match | LZ |  |
| codex / trial3 | match | match | match | match | — |  |
...
| codex / trial1 | match | ok | match | incorrect | — |  |
| codex / trial2 | match | ok | concerning | ok | LZ |  |
...
| claude-code / trial3 | match | match | match | match | — |  |
| codex / trial1 | match | match | match | match | — |  |
| codex / trial2 | concerning | incorrect | match | match | LZ |  |
| codex / trial3 | match | match | match | match | — |  |
...
| Agent / trial | LZ | KB | Claude judge | Codex judge | Best | Why |
|---|---|---|---|---|---|---|
| claude-code / trial1 | match | ok | better | concerning | LZ |  |
| claude-code / trial2 | match | ok | concerning | concerning | LZ |  |
| claude-code / trial3 | match | ok | concerning | concerning | LZ |  |
| codex / trial1 | match | match | match | ok | — |  |
...
| codex / trial1 | match | ok | concerning | ok | LZ |  |
| codex / trial2 | match | ok | ok | concerning | — |  |
| codex / trial3 | match | ok | concerning | better | LZ |  |
...
| codex / trial2 | better | ok | concerning | ok | LZ |  |
| codex / trial3 | better | ok | incorrect | concerning | LZ |  |
