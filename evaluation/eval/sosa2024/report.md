...
| 7-c | How is `output` *Distance to reward zone* thresholded into categories? | 🔵🔵🔵 🔵🔵🔵 | 🟢🟢🟢 🟢🟢🟢 | 🟢🟢🟢 🟢🟢🟢 | All solution are the same, don't like the == 0 operation though, the manual ref uses a tiny threshold (1e-6 instead) |  |  |
| 7-d | How is `output` *Distance to reward zone* aligned with the neural data? | 🟢🟢🟢 🟢🔴🟢 | 🟢🟢🟢 🟢🟢🟢 | 🟢🟢🟢 🟢🟢🟢 |  |  |  |
| 8-a | What variables in the raw data is `output` *Absolute position* derived from? | 🟢🟢🟢 🟢🟢🟢 | 🟢🟢🟢 🟢🟢🟢 | 🟢🟢🟢 🟢🟢🟢 |  |  |  |
| 8-b | What processing is involved in computing `output` *Absolute position*? | 🟢🟢🟢 🟢🟢🟢 | 🟢🟢🟢 🟢🟡🟢 | 🟢🟢🟢 🔴🔵🔴 |  |  |  |
| 8-c | How is `output` *Absolute position* thresholded into categories? | 🟢🟢🟢 🟢🟢🟢 | 🟡🔴🟡 🟡🔴🟡 | 🟣🔴🟣 🔴🟣🔴 |  | Judge rating very inconsistent |  |
