...
**Note:** rely on assumptions, more likely to result in error
...
**Note:** 100 ms time bin is a strange choice
...
**Note:** did now use pupil_width directly but try to compute from area
