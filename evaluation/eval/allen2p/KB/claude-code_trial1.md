...
**Note:** agent filters to passive experiments, not VisualBehavior experiments
...
**Note:** the agent uses ophys_experiment_id instead of the correct ophys_session_id
