...
**Note:** binning is weird, but that is a different question
...
**Note:** sets time bin to be way too big, 750 ms is too long
...
**Note:** not ideal to load and parse multiple times
