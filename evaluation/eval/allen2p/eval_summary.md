...
|---|---|---|---|---|---|
| claude-code / trial1 | ok | ok | incorrect | LZ |  |
| claude-code / trial2 | ok | ok | incorrect | LZ |  |
| claude-code / trial3 | ok | ok | incorrect | LZ |  |
| codex / trial1 | ok | ok | incorrect | LZ |  |
| codex / trial2 | ok | ok | incorrect | LZ |  |
...
| Agent / trial | LZ | Claude judge | Codex judge | Best | Why |
|---|---|---|---|---|---|
| claude-code / trial1 | match | match | incorrect | LZ |  |
...
| claude-code / trial3 | match | match | concerning | LZ |  |
| codex / trial1 | match | concerning | concerning | LZ |  |
| codex / trial2 | match | match | concerning | LZ |  |
...
| claude-code / trial1 | match | match | match | — |  |
| claude-code / trial2 | match | match | match | — |  |
| claude-code / trial3 | ok | incorrect | incorrect | LZ |  |
| codex / trial1 | ok | concerning | incorrect | LZ |  |
| codex / trial2 | ok | incorrect | incorrect | LZ |  |
| codex / trial3 | ok | concerning | incorrect | LZ |  |
...
| Agent / trial | LZ | Claude judge | Codex judge | Best | Why |
|---|---|---|---|---|---|
| claude-code / trial1 | match | concerning | match | LZ |  |
| claude-code / trial2 | match | match | concerning | LZ |  |
| claude-code / trial3 | match | match | incorrect | LZ |  |
| codex / trial1 | match | match | ok | — |  |
| codex / trial2 | match | match | ok | — |  |
| codex / trial3 | match | match | incorrect | LZ |  |
...
| codex / trial2 | match | match | incorrect | LZ |  |
| codex / trial3 | match | match | incorrect | LZ |  |
...
|---|---|---|---|---|---|
| claude-code / trial1 | match | match | match | — |  |
| claude-code / trial2 | match | ok | incorrect | LZ |  |
| claude-code / trial3 | match | match | incorrect | LZ |  |
| codex / trial1 | match | match | incorrect | LZ |  |
| codex / trial2 | match | match | incorrect | LZ |  |
| codex / trial3 | match | match | incorrect | LZ |  |
...
| codex / trial1 | concerning | concerning | incorrect | — |  |
| codex / trial2 | ok | concerning | incorrect | LZ |  |
| codex / trial3 | ok | incorrect | incorrect | LZ |  |
...
|---|---|---|---|---|---|
| claude-code / trial1 | match | match | match | — |  |
| claude-code / trial2 | incorrect | ok | incorrect | LZ |  |
| claude-code / trial3 | match | match | incorrect | LZ |  |
| codex / trial1 | match | match | incorrect | LZ |  |
| codex / trial2 | match | match | incorrect | LZ |  |
| codex / trial3 | match | match | incorrect | LZ |  |
...
| Agent / trial | LZ | Claude judge | Codex judge | Best | Why |
|---|---|---|---|---|---|
| claude-code / trial1 | match | ok | incorrect | LZ |  |
| claude-code / trial2 | match | ok | ok | — |  |
| claude-code / trial3 | match | ok | incorrect | LZ |  |
| codex / trial1 | ok | concerning | incorrect | LZ |  |
| codex / trial2 | ok | ok | concerning | LZ |  |
| codex / trial3 | ok | concerning | incorrect | LZ |  |
...
| claude-code / trial3 | match | match | concerning | LZ |  |
| codex / trial1 | match | concerning | incorrect | LZ |  |
| codex / trial2 | match | ok | concerning | LZ |  |
| codex / trial3 | match | concerning | incorrect | LZ |  |
...
| claude-code / trial3 | match | ok | concerning | LZ |  |
| codex / trial1 | ok | ok | incorrect | LZ |  |
| codex / trial2 | ok | concerning | incorrect | LZ |  |
| codex / trial3 | ok | concerning | concerning | LZ |  |
...
|---|---|---|---|---|---|
| claude-code / trial1 | match | match | incorrect | LZ |  |
| claude-code / trial2 | match | ok | concerning | LZ |  |
...
| Agent / trial | LZ | Claude judge | Codex judge | Best | Why |
|---|---|---|---|---|---|
| claude-code / trial1 | concerning | match | concerning | LZ |  |
| claude-code / trial2 | concerning | match | match | LZ |  |
| claude-code / trial3 | concerning | match | ok | LZ |  |
| codex / trial1 | concerning | match | ok | LZ |  |
| codex / trial2 | concerning | match | ok | LZ |  |
| codex / trial3 | concerning | match | concerning | LZ |  |
...
| Agent / trial | LZ | Claude judge | Codex judge | Best | Why |
|---|---|---|---|---|---|
| claude-code / trial1 | ok | match | concerning | LZ |  |
...
| Agent / trial | LZ | Claude judge | Codex judge | Best | Why |
|---|---|---|---|---|---|
| claude-code / trial1 | concerning | match | incorrect | LZ |  |
| claude-code / trial2 | concerning | better | incorrect | LZ | I think the LLM judge did not parse this Q correctly |
| claude-code / trial3 | incorrect | incorrect | incorrect | — |  |
| codex / trial1 | concerning | match | concerning | LZ |  |
| codex / trial2 | concerning | match | incorrect | LZ |  |
...
| claude-code / trial2 | concerning | better | incorrect | LZ |  |
