...
| 1-e | How are trials filtered based on quality controls? | 🟡🟡🟡 🟢🟡🟢 | 🔵🔵🔵 🔵🔵🔵 | 🟢🟢🟢 🟡🟢🟡 | 🔴🔴🟡 🔴🔴🔴 | Filtering out extremely long "trials" where the animal is stationary is required; this was only implemented in the 3 codex trials. |  | `FILTER=4` |
