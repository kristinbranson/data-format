...
| 4-b | What processing is involved in computing `input` *day_of_training*? | 🟡🔴🟢 🟡🟡🟡 | ⚫⚫⚫ ⚫⚫⚫ | ⚫⚫⚫ ⚫⚫⚫ | the wording is a bit ambiguous but i think we are asking for number of training days, not actual date difference |  |  |
