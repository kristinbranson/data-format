...
| 1-e | How are trials filtered based on quality controls? | 🟡🟡🟡 🔵🟢🟢 | 🟢🟢🟡 🟡🟢🟢 | 🟢🟢🔴 🟡🟢🟢 | Should filter out extremely long "trials" where the animal is stationary; this was only implemented in the 3 codex trials. |  | `FILTER=3` |
...
| 3-b | What processing is involved in computing `output` *visual_stimulus*? | 🟢🔴🟢 🟢🟢🟢 | 🟢🟢🟢 🟢🟢🟢 | 🟢🟡⚫ 🟢🟢🟢 | 1/6 trials remapped and merged stimulus categories (e.g., rock→circle, wood→leaf) for no apparent reason. |  | `MISC=1` |
...
| 5-b | What processing is involved in computing `output` *position*? | 🟢🔵🔴 🟢🟢🟢 | 🟢🟢🟢 🟢🟢🟢 | 🟢🔴⚫ 🟢🟢🟢 | Two claude trials did not handle the bin edges correctly with respect to the grey-corridor region. |  | `PROCESS=2` |
...
| 6-b | What processing is involved in computing `output` *running_speed*? | 🔵🟡🟡 🟢🟢🟢 | 🟢🟡🟢 🟢🟢🟢 | 🟢🔴⚫ 🟢🟢🟢 | In 2/6 trials the agent did not properly handle the speed-bin edges for frames with near zero speed. |  | `PROCESS=2` |
