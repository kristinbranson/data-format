...
**Note:** selects neurons with |d'| > threshes
...
**Note:** manual makes trials all the same length, which was not necessary for the data spec. this requires padding shorter trials
...
**Note:** assumes constant frame rate
