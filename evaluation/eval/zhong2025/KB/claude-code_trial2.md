...
**Note:** does not filter gray frames between trials
...
**Note:** does not filter gray frames in between trials
...
**Note:** assumes a constant frame rate
...
**Note:** mostly ok, but does some weird mapping for rock and wood stimuli, not sure if these come up:  'rock1': 'circle1', 'rock2': 'circle2', 'wood1': 'leaf1', 'wood2': 'leaf2', 'wood1_swap1': 'leaf1_swap1', 'wood1_swap2': 'leaf1_swap2', 'brick1': 'circle1', 'brick2': 'circle2', 'brick5': 'leaf3', 'wood5': 'leaf3', 'rock5': 'circle3'
...
**Note:** output pkl file is quite large
