...
| Agent / trial | LZ | KB | Claude judge | Codex judge |
|---|---|---|---|---|
| claude-code / trial1 | match | better | better | incorrect |
| claude-code / trial2 | match | better | ok | incorrect |
| claude-code / trial3 | match | better | concerning | incorrect |
| codex / trial1 | match | better | better | better |
| codex / trial2 | match | better | ok | incorrect |
| codex / trial3 | match | better | better | incorrect |
...
| claude-code / trial2 | match | match | match | match |
| claude-code / trial3 | match | match | match | match |
| codex / trial1 | match | match | better | match |
| codex / trial2 | match | match | match | ok |
| codex / trial3 | match | match | match | match |
...
| claude-code / trial2 | match | incorrect | concerning | incorrect |
| claude-code / trial3 | match | match | concerning | match |
...
| codex / trial1 | match | match | better | better |
| codex / trial2 | match | match | better | incorrect |
| codex / trial3 | match | match | better | incorrect |
...
| codex / trial3 | match | concerning | better | incorrect |
...
| codex / trial1 | better | ok | better | better |
...
| claude-code / trial1 | match | ok | match | ok |
| claude-code / trial2 | match | ok | match | ok |
| claude-code / trial3 | match | ok | incorrect | ok |
