...
| Agent / trial | Human | Claude judge | Codex judge | Best | Why |
|---|---|---|---|---|---|
| claude-code / trial1 | match | better | incorrect | Human |  |
...
| claude-code / trial2 | match | match | match | — |  |
| claude-code / trial3 | match | match | match | — |  |
| codex / trial1 | match | better | match | Human |  |
| codex / trial2 | match | match | ok | — |  |
| codex / trial3 | match | match | match | — |  |
...
| claude-code / trial3 | match | concerning | match | Human |  |
| codex / trial1 | match | better | better | Human |  |
...
| claude-code / trial1 | match | better | incorrect | Human |  |
| claude-code / trial2 | match | ok | incorrect | — |  |
| claude-code / trial3 | match | incorrect | incorrect | Human |  |
| codex / trial1 | match | better | better | Human |  |
| codex / trial2 | match | ok | incorrect | — |  |
| codex / trial3 | match | better | incorrect | Human |  |
...
| claude-code / trial1 | match | match | ok | — |  |
| claude-code / trial2 | match | match | ok | — |  |
| claude-code / trial3 | match | incorrect | ok | Human |  |
