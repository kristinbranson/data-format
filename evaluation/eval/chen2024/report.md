...
| 1-c | How are the data split into sessions? | 🟡🟢🟡 🟢🟢🟢 | 🟢🟢🟡 🟢🟢🟢 | 🟢🟢🟢 🟢🟢🟢 | Performance-based session filtering is not necessary. |  | `EXTRAFILTER` |
| 1-d | Are the data correctly split into trials? | 🟢🟢🟢 🟡🟢🟢 | 🟢🟢🟢 🟡🟢🟢 | 🟢🟢🟢 🟢🟢🟢 |  |  |
| 1-e | How are trials filtered based on quality controls? | 🟢🟢🟢 🔵🔵🔴 | 🟢🟢🟡 🟡🟢🟡 | 🟢🟡🟢 🟡🟡🟡 | Slightly different filtering procedures across agents; 1/6 was incorrect (used the observation window from only a *single* good unit). |  | `UNDERFILTER` |
...
| 3-a | What variables in the raw data is `output` *choice* derived from? | 🔴🔴🟢 🔵🟢🟢 | 🟢🟢🟢 🟡🟢🟢 | 🟢🔴🟡 🟡🟢🟢 | 2/6 trials used the *instructed* lick direction instead of the *actual* behavioral response. | The LLM judges failed to flag the trials where this mistake was made. | `VARNAME` |
| 3-b | What processing is involved in computing `output` *choice*? | 🔴🔴🟡 🔵🟢🟢 | 🟢🟢🟡 🟡🟢🟡 | 🟢🔴🟡 🟡🟡🟡 | This part is also tricky — the agent must derive the actual behavioral response and additionally handle the case where the animal did not respond. |  | `COMPLEX` |
...
| 6-c | How is `output` *tongue_y_position* aligned with the neural data? | 🟢🟢🟢 🟢🟢🟢 | 🟢🟢🟢 🟢🟢🟢 | 🟢🟢🟢 🟢🟢🟢 | Nominally identical procedure across all agents; slight variation in implementation details. |  | `OUTLIERFILTER` |
| 7 | How are minor mistakes in the data, e.g. missing data, handled? | 🟢🟢🟢 🔵🟢🟢 | 🟢🟡🟡 🟡🟢🟢 | 🟡🟡🟡 🟡🟡🟡 |  |  |
| 8-a | What are the most time-consuming steps of the code? | 🔵🔵🔵 🟢🟢🟢 | 🟢🟢🟢 🟢🟢🟢 | 🟢🟢🟢 🟢🟢🟢 | The claude variants are less efficient — they keep a per-trial spike-binning loop instead of vectorizing across trials. |  | `INEFFICIENT` |
