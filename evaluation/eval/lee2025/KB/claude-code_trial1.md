...
**Note:** agent loads the extension-less data files with joblib.load, while manual uses the mat file. agent hardcodes animal names
...
**Note:** manual truncates after full 60 second trials, while agent rounds
