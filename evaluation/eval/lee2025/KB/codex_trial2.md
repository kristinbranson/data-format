...
**Note:** i think dropping frames and then smoothing is problematic. also it does gaussian filtering and pooling which is weird
...
**Note:** agent uses a threshold of 5, manual uses any, spotchecked that these are the same
