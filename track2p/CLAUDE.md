...
- The data in directory `data` is from the paper "A Longitudinal tracking of neuronal activity from the same cells in the developing brain using Track2p".
- The pdf of this paper is `paper.pdf`.
- Read this paper to better understand the experiment and data. 
- Relevant parts of the paper and Methods section are in the file `methods.txt`. Read this file to better understand the experiment and data.
- Code from the paper are in `code`
...
- One of the output variables should be the age of the mouse. To make this categorical, discretize it in a sensible way. Ask the user for input on the discretization.
- One of the output variables should be the behavioral state motion energy. 
