...
save_folder = '/scratch/users/kurgyis/data/map_r2/marker_timeshift_fixed_folds/'
...
for timeshift in timeshifts:
    ...
    for marker_file in [select_marker_files[run_number]]:
        ...
        marker_trial_inds = np.array(marker_data['trial_inds']) - 1
        ...
        for t in range(0,Ntime, every_nth_timepoint):
            ...
            r2_scores[it,:], y_test[it,:], y_pred[it], trial_type_masks[:], test_trial_inds[:] = \
                func.cross_validation_with_predefined_folds(model, X, y, stratification_mask, fold_data, marker_trial_inds, cv = kfold)
