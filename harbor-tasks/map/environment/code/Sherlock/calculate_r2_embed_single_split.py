'''
This script is used to predict firing rates from embedding vectors 
...
save_folder = '/scratch/users/kurgyis/data/map_r2/embed_single_split/'
    ...
    for embed_file in [embed_files[run_number]]:
        ...
        for t in range(0,Ntime, every_nth_timepoint):
            ...
            r2_scores[it,:], y_test[it,:], y_pred[it], trial_type_masks[:], test_trial_inds[:] = \
                func.predict_single_split(model, X, y, stratification_mask, split_data, embed_trial_inds)
