...
save_folder = '/oak/stanford/groups/shauld/kurgyis/data/Map_r2_scores/marker/'
...
for timeshift in timeshifts:
    ...
    for marker_file in [select_marker_files[run_number]]:
        ...
        marker_over_time = marker_aligned[:,regular_trials==1,:]

        Ntime, trials, n = marker_over_time.shape
        ...
        for t in range(0,Ntime, every_nth_timepoint):
            ...
            X = np.concatenate(marker_over_time[start:end], axis = 1) # Reshape to [trials, features]
