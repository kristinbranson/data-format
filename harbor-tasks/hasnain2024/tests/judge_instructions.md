...
Compare the AI's decisions (from Step 2) with the instructions (`instructions_reference.md`), which involved replicating the analysis in the reference paper (`/app/paper.pdf` and `/app/methods.txt`) and code (`/app/code`).
