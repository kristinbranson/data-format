function varargout=shadedErrorBar(x,y,errBar,lineProps,transparent, plotax)
...
H.mainLine=plot(plotax,x,y,lineProps{:});
...
H.patch=patch(plotax,xP,yP,1,'facecolor',patchColor,...
              'edgecolor','none',...
              'facealpha',faceAlpha);


%Make pretty edges around the patch. 
H.edge(1)=plot(plotax,x,lE,'-','color',edgeColor);
H.edge(2)=plot(plotax,x,uE,'-','color',edgeColor);
