...
**Agentic AI Outputs**:
- Summary of the decisions the AI made is in `/logs/verifier/judge/DECISIONS.md`. 
...
**Human Solution**:
- The human-generated solution code is in `/tests/reference_convert_data.py`
- Human-generated descriptions of the decisions are in `/tests/reference_DECISIONS.md`. 
...
**Step 1**. The AI's goal was to load, process, and reformat the data from a neuroscience paper into a specified structure suitable for downstream analysis, using the **SAME** processing described in the provided reference paper and code. 
  - Read through the `/tests/instruction_reference.md` to understand the task. 
  - Read through `/logs/verifier/judge/DECISIONS.md` to understand the AI's decisions.
  - Read through `/tests/reference_DECISIONS.md` to understand the human's decisions. 
