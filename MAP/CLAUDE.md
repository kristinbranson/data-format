...
- The data are quite large. First reformat a small sample of up to 2 mice with up to 20 trials each to debug. Choose trials to cover all input and output values. Only after train_decoder.py works on the sample data, reformat the whole dataset.
